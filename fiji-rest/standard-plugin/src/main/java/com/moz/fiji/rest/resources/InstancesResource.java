...
import static com.moz.fiji.rest.RoutesConstants.INSTANCES_PATH;
...
public class InstancesResource {
   ...
   */
  public InstancesResource(FijiClient fijiClient) {
  ...
  public List<GenericResourceRepresentation> getInstanceList() {
    ...
    for (String instance : mFijiClient.getInstances()) {
