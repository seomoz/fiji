...
module FijiRest
  ...
  # Provides a simple wrapper interface around the FijiREST server. The return of most
  ...
  class Client
    ...
    class FijiRestClientError < StandardError
    ...
    #
    # Constructor for the FijiRest::Client. The only optional argument is the base_uri
    ...
    #                                                         schema (Avro) OR the Fiji ID of the
    #                                                         schema>
    #                                     },
    #                                       ...
    #                                   ]
    ...
    # Generic method that will raise a FijiRestClientError that contains a JSON object
    ...
    def raise_exception(response_body)
      begin
        raise FijiRestClientError.new(JSON.parse(response_body))
      rescue
        ...
        raise FijiRestClientError.new(json_error)
      end
    end
