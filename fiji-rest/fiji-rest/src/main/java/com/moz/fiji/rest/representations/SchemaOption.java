 ...
 * or the unique identifier that Fiji assigns to new Avro schemas.
 *
 */
public class SchemaOption {
   ...
   *
   * @param schemaUid is the Fiji assigned UID for the schema.
   */
   ...
   *         UID is set.
   */
  public Schema resolve(FijiSchemaTable schemaTable) throws IOException {
