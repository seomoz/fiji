...
public final class BulkImporterTestUtils {
  ...
  public static final String CSV_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestCSVImportInput.txt";

  public static final String TIMESTAMP_CSV_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TimestampCSVImportInput.txt";

  public static final String TSV_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestTSVImportInput.txt";

  public static final String JSON_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestJSONImportInput.txt";

  public static final String XML_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestXMLImportInput.txt";

  public static final String COMPLEX_JSON_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestComplexJSONImportInput.txt";

  public static final String HEADERLESS_CSV_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/HeaderlessCSVImportInput.txt";

  public static final String PRIMITIVE_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestPrimitiveImportInput.txt";

  public static final String LOCAL_RESOURCE_PREFIX = "src/test/resources/";

  public static final String FOO_IMPORT_DESCRIPTOR =
    "com.moz.fiji/mapreduce/lib/mapping/foo-test-import-descriptor.json";

  public static final String FOO_TIMESTAMP_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-timestamp-import-descriptor.json";

  public static final String FOO_TIMESTAMP_XML_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-timestamp-xml-import-descriptor.json";

  public static final String FOO_JSONPATH_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-jsonpath-import-descriptor.json";

  public static final String FOO_XML_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-xml-import-descriptor.json";

  public static final String FOO_LG_XML_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-lg-xml-import-descriptor.json";

  public static final String FOO_PRIMITIVE_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-primitive-import-descriptor.json";

  public static final String FOO_INVALID_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/foo-test-invalid.json";

  public static final String COMMON_LOG_LAYOUT =
      "com.moz.fiji/mapreduce/lib/layout/commonlog-layout.json";

  public static final String COMMON_LOG_IMPORT_DATA =
      "com.moz.fiji/mapreduce/lib/mapping/TestCommonLog.log";

  public static final String COMMON_LOG_IMPORT_DESCRIPTOR =
      "com.moz.fiji/mapreduce/lib/mapping/commonlog-import-descriptor.json";
  ...
  /**
   * Validates that the imported rows match up with the expected results.  The imported FijiRowData
   * can come from a FijiRowScanner.
   *
   * @param importedFijiRowData an iterable of FijiRowData whose contents to validate.
   ...
   */
  public static void validateImportedRows(Iterable<FijiRowData> importedFijiRowData,
      boolean validateTimestamps)
      throws IOException {
    long rowsProcessed = 0;
    for (FijiRowData row : importedFijiRowData) {
