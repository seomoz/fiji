...
import com.moz.fiji.mapreduce.lib.bulkimport.BinaryHTableBulkImporter.BinaryHBaseCellDecoder;
import com.moz.fiji.mapreduce.lib.bulkimport.BinaryHTableBulkImporter.ColumnDescriptor;
...
public class TestBinaryHTableBulkImporter {
  ...
  public void testColumnDescriptor() throws IOException {
    ...
    assertEquals(new FijiColumnName("info:name"), columnDescriptor.getFijiColumnName());
  }
