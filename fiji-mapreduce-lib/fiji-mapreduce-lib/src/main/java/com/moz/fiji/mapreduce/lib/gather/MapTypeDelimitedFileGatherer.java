 ...
 * You can set this value by setting the fiji.export.field.delimiter configuration variable.
 * You must guarantee that the delimiter you choose does not appear in the json
 * representation of your data.</p>
 */
public class MapTypeDelimitedFileGatherer extends FijiGatherer<Text, NullWritable> {
  /**
   ...
   * match any character in the json representation of Fiji data.
   * Choose an appropriate delimiter.
   */
  private static final String CONF_FIELD_DELIMITER = "fiji.export.field.delimiter";

  /** Default delimiter to use for writing column values into hdfs. */
  private static final String DEFAULT_FIELD_DELIMITER = "|";

  /** The Map-type family to export. */
  private static final String CONF_EXPORT_FAMILY = "fiji.export.map.family";

  /** The maximum number of versions to return for any key. */
  private static final String CONF_MAX_VERSIONS = "fiji.export.max.versions";
