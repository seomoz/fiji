...
/**
 * A program that runs the {@link com.moz.fiji.mapreduce.lib.examples.EmailDomainCountGatherer}
 * over a Fiji table.
 *
 ...
 * &gt;   com.moz.fiji.mapreduce.lib.examples.EmailDomainCountGatherJob \
...
public class EmailDomainCountGatherJob extends Configured implements Tool {
   ...
   * USAGE:
   *
   *     EmailDomainCountGatherJob &lt;fiji-instance&gt; &lt;fiji-table&gt; &lt;output-path&gt;
   *       &lt;num-splits&gt;
   *
   * ARGUMENTS:
   *
