...
import com.moz.fiji.mapreduce.lib.graph.NodeBuilder;
 ...
 * </ul>
 *
 * <p>If the associations <code>KeyValueStore</code> is a <code>FijiTableKeyValueStore</code>,
 ...
 * </ul>
 */
public abstract class NaiveRecommendationProducer extends FijiProducer {
   ...
   */
  protected abstract Node getAffinities(FijiRowData input, ProducerContext context)
      throws IOException;
   ...
   * <code>FijiTableKeyValueStore</code>, this method must be overridden to appropriately
