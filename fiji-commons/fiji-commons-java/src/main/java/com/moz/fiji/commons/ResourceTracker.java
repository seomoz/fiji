...
public final class ResourceTracker {
  ...
  public static final String TRACKING_LEVEL_PROPERTY =
      "com.moz.fiji.commons.ResourceTracker.tracking_level";
   ...
   * {@link com.moz.fiji.commons.ResourceTracker.TrackingLevel}.
   */
    ...
    private final ExecutorService mExecutorService =
        Executors.newSingleThreadExecutor(
            new ThreadFactoryBuilder()
                .setDaemon(true)
                .setNameFormat("com.moz.fiji.commons.ResourceTracker.ReferenceTracker")
                .build());
