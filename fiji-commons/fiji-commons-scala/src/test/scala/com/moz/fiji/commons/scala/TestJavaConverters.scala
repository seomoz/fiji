...
package com.moz.fiji.commons.scala
...
class TestJavaConverters {
  ...
  private def testScalaToJava[T](
    ...
    import com.moz.fiji.commons.scala.JavaConverters.OptionAsOptional
  ...
  private def testJavaToScala[T](
    ...
    import com.moz.fiji.commons.scala.JavaConverters.OptionalAsOption
