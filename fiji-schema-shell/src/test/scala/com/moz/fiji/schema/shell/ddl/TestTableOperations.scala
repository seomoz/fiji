...
import com.moz.fiji.schema.avro._
...
class TestTableOperations extends CommandTestCase {
  "Various table operations" should {
    "create a table" in {
      ...
      val maybeLayout2 = env.fijiSystem.getTableLayout(
          defaultURI, "foo")
    ...
    "Set and alter the table MEMSTORE FLUSH SIZE property" in {
      ...
      val maybeLayout3 = env3.fijiSystem.getTableLayout(defaultURI, "foo")
    ...
    "create a table and add a column" in {
      ...
      val maybeLayout3 = env.fijiSystem.getTableLayout(
          defaultURI, "foo")
      maybeLayout3 must beSome[FijiTableLayout]
      val layout3 = maybeLayout3.get.getDesc
    ...
    */
    ...
    "create a table and update a locality group property" in {
      ...
      val maybeLayout3 = env3.fijiSystem.getTableLayout(
          defaultURI, "foo")
      maybeLayout3 must beSome[FijiTableLayout]
      val layout3 = maybeLayout3.get.getDesc
      val locGroups3 = layout3.getLocalityGroups()
    ...
    "alter a map type family schema" in {
      ...
      val maybeLayout4 = env.fijiSystem.getTableLayout(
          defaultURI, "foo")
      maybeLayout4 must beSome[FijiTableLayout]
    ...
    "alter a column schema" in {
      ...
      // Check that the new family exists.
      val maybeLayout2 = env3.fijiSystem.getTableLayout(
          defaultURI, "foo")
      maybeLayout2 must beSome[FijiTableLayout]
      val layout2 = maybeLayout2.get.getDesc
      val locGroups2 = layout2.getLocalityGroups()
    ...
    "dump table ddl correctly" in {
      ...
      val maybeLayout = env3.fijiSystem.getTableLayout(
          defaultURI, "foo")
      ...
      val maybeLayout2 = env4.fijiSystem.getTableLayout(
          defaultURI, "foo")
      ...
      val maybeLayout3 = env4.fijiSystem.getTableLayout(
          defaultURI, "foo")
      maybeLayout3 must beSome[FijiTableLayout]
      val layout3 = maybeLayout3.get.getDesc
  ...
  def getSchemaTextFor(env: Environment, avroSchema: AvroSchema): String = {
    return env.fijiSystem.getSchemaFor(env.instanceURI, avroSchema).get.toString
  }
