...
package com.moz.fiji.schema.shell.spi
 ...
 *   `src/main/resources/META-INF/services/com.moz.fiji.schema.shell.spi.ParserPluginFactory`.
 *       </li>
 *   <li>In this file, include the fully-qualified name of your factory class.</li>
 *   <li>Create a [[com.moz.fiji.schema.shell.spi.ParserPlugin]] implementation that extends
 ...
 * <ul>
 *   <li>Make sure your compiled jar file is on the classpath of the Fiji schema shell.</li>
