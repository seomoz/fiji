...
def BuildFlagParser():
  """Builds a flag parser for the FijiMusic data generator tool.

  Returns:
    Command-line flag parser.
  """
  parser = argparse.ArgumentParser(
    description='FijiMusic data generator.'
  )
  parser.add_argument(
    '--output-dir',
    dest='output_dir',
...
class FijiMusicDataGenerator(object):
  """Data generator for the FijiMusic tutorial."""
  ...
  def Generate(self):
    """Generates data for the FijiMusic tutorial."""
...
def main(args):
  ...
  generator = FijiMusicDataGenerator()
