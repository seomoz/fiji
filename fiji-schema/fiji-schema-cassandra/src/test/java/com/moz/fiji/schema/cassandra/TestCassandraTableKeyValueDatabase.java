 ...
 */
public class TestCassandraTableKeyValueDatabase extends CassandraFijiClientTest {
  ...
  private FijiTableKeyValueDatabase mDb;

  @Before
  public final void setupTable() throws IOException {
    // This will install a new Fiji instance.
    final Fiji fiji = getFiji();

    // Get an admin and create a table for this instance.
    FijiURI fijiURI = fiji.getURI();
    //mAdmin = CassandraFactory
        //.Provider
        //.get()
        //.getCassandraAdminFactory(fijiURI)
        //.create(fijiURI);

    // Fill it with some data.
    mDb = fiji.getMetaTable();
