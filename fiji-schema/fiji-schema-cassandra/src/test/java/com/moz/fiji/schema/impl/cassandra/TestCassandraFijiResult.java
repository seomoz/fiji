...
public class TestCassandraFijiResult extends CassandraFijiClientTest {
  ...
  private CassandraFijiTable mTable;
  private CassandraFijiTableReader mReader;

  @Before
  public void setupTestCassandraFijiResult() throws IOException {
    ...
    final TableBuilder tableBuilder =
        new InstanceBuilder(getFiji())
            .withTable(FijiTableLayouts
                    .getLayout("com.moz.fiji/schema/layout/all-types-no-counters-schema.json"));
    ...
    mTable = getFiji().openTable("all_types_table");
    mReader = mTable.openTableReader();
  }

  @After
  public void cleanupTestCassandraFijiRowView() throws IOException {
    mTable.release();
    mReader.close();
  }
