...
public class TestCassandraFormattedRowKeys extends FijiClientTest {
  // TODO: Run these tests once C* Fiji supports scans over primary key ranges.
  /*
  ...
  public final void setup() throws Exception {
    ...
    mDataRequest = FijiDataRequest.builder()
  ...
  public void testFormattedRKF() throws IOException {
    ...
    FijiRowData result = mReader.get(mTable.getEntityId("x", "a", "bc"), mDataRequest);
  ...
  public void testFormattedKeyOrdering() throws IOException {
    ...
    final FijiRowScanner scanner = mReader.getScanner(mDataRequest);
    try {
      final Iterator<FijiRowData> resultIterator = scanner.iterator();
