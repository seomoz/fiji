...
package com.moz.fiji.schema.cassandra.util;
...
public class TestSessionCache {
  ...
  public void testClustersAreCached() throws Exception {
    ...
    final List<String> contactPoints = CassandraFijiClientTest.EmbeddedCassandra.getContactPoints();
    final int contactPort = CassandraFijiClientTest.EmbeddedCassandra.getContactPort();
