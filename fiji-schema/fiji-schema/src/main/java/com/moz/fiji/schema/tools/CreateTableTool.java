...
import com.moz.fiji.schema.util.SplitKeyFile;

/**
 * Command-line tool for creating fiji tables in fiji instances.
 */
@ApiAudience.Private
public final class CreateTableTool extends BaseTool {
  ...
  @Flag(name="table", usage="URI of the Fiji table to create,"
      + " eg. --table=fiji://hbase-address/fiji-instance/table.")
  ...
  /** FijiURI of the table to create. */
  ...
  public String getDescription() {
    return "Create a fiji table in a fiji instance.";
  }
  ...
  protected void validateFlags() throws Exception {
    ...
    Preconditions.checkArgument((mTableURIFlag != null) && !mTableURIFlag.isEmpty(),
        "Specify the table to create with --table=fiji://hbase-address/fiji-instance/table");
      ...
      default:
        throw new RuntimeException(
            "Unexpected row key encoding: "
                + FijiTableLayout.getEncoding(tableLayout.getKeysFormat()));
      }
  ...
  public static void main(String[] args) throws Exception {
    System.exit(new FijiToolLauncher().run(new CreateTableTool(), args));
  }
}
