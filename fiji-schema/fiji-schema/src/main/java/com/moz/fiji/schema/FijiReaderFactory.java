 ...
 *
 * <p> Use <code>FijiTable.getReaderFactory()</code> to get a reader.
 */
@ApiAudience.Public
@ApiStability.Evolving
@Inheritance.Sealed
public interface FijiReaderFactory {
  ...
  /**
   * Opens a new reader for the FijiTable associated with this reader factory.
   *
   * <p>
   ...
   * </p>
   *
   * @return a new FijiTableReader.
   * @throws IOException on I/O error.
   */
  FijiTableReader openTableReader() throws IOException;
   ...
   *   final FijiColumnName column = new FijiColumName("family", "qualifier");
   *   // Force the Avro reader schema for family:qualifier to be this schema:
   *   final Schema myReaderSchema = ...
   *
   *   final Map<FijiColumnName, CellSpec> overrides = ImmutableMap.builder()
   ...
   * {@link CellSpec#setDecoderFactory(FijiCellDecoderFactory)}:
   *
   * <pre><tt>{@code
   *   final FijiTable table = ...
   *   final FijiColumnName column = new FijiColumName("family", "qualifier");
   ...
   */
  @Deprecated
  FijiTableReader openTableReader(Map<FijiColumnName, CellSpec> overrides) throws IOException;

  /**
   * Get a new FijiTableReaderBuilder which builds readers for the table associated with this
   * factory.
   *
   * <p>
   ...
   *       ColumnReaderSpec as an override in a FijiDataRequest without having specified that
   ...
   *       {@link com.moz.fiji.schema.FijiTableReaderBuilder.OnDecoderCacheMiss#FAIL} if the
   *       ColumnReaderSpec override in a FijiDataRequest was also specified in the alternatives
   ...
   * </p>
   *
   * @return a new FijiTableReaderBuilder.
   */
  FijiTableReaderBuilder readerBuilder();
}
