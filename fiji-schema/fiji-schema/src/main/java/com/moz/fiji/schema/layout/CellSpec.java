...
import com.moz.fiji.schema.util.JavaIdentifiers;

/**
 * Specification of a column in a Fiji table.
 *
 ...
 * </p>
 * <p> A CellSpec is constructed from a {@link FijiTableLayout}
 *    and is intended for a consumption by {@link com.moz.fiji.schema.FijiCellEncoder}
 *    and {@link com.moz.fiji.schema.FijiCellDecoder}.
 * </p>
 */
...
public final class CellSpec {
  ...
  private FijiCellDecoderFactory mDecoderFactory = SpecificCellDecoderFactory.get();

  /** Factory for cell encoders. */
  private FijiCellEncoderFactory mEncoderFactory = DefaultFijiCellEncoderFactory.get();
      ...
      switch (mCellSchema.getType()) {
        ...
        case CLASS: {
          ...
          try {
            ...
            // In FijiSchema 1.0, if the specific class isn't found on the classpath,
            // fall back on using the writer schema:
            setUseWriterSchema();
          }
          break;
        }
        default: throw new InternalFijiError("Unknown Avro cell type: " + mCellSchema);
      }
    }
    return this;
  }
   ...
   * @return this CellSpec.
   */
  public CellSpec setSchemaTable(final FijiSchemaTable schemaTable) {
   ...
   * @return this CellSpec.
   */
  public CellSpec setDecoderFactory(final FijiCellDecoderFactory decoderFactory) {
   ...
   */
  public FijiCellDecoderFactory getDecoderFactory() {
   ...
   * @return this CellSpec.
   */
  public CellSpec setEncoderFactory(final FijiCellEncoderFactory encoderFactory) {
   ...
   */
  public FijiCellEncoderFactory getEncoderFactory() {
  ...
  public Schema getAvroSchema() {
    ...
    switch (mAvroReaderSchema) {
      ...
      default: throw new InternalFijiError("Invalid Avro reader schema: " + mAvroReaderSchema);
    }
  }
   ...
   * @return this CellSpec.
   */
  public CellSpec setColumnURI(FijiURI uri) {
