...
/**
 * A FijiRowFilter that only includes rows where a specific column's most recent value
 * equals a specified value.
 *
 * <p>This filter will only pass if the data in the Fiji cell matches the specified value
 * <i>exactly</i>.  Both the data and the Avro schema must be the same.</p>
 */
@ApiAudience.Public
@ApiStability.Evolving
public final class ColumnValueEqualsRowFilter extends FijiRowFilter {
  ...
  public FijiDataRequest getDataRequest() {
    return FijiDataRequest.create(mFamily, mQualifier);
  }
