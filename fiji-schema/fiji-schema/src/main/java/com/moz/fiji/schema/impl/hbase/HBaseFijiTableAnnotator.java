...
/** HBase implementation of {@link com.moz.fiji.schema.FijiTableAnnotator}. */
@ApiAudience.Private
public final class HBaseFijiTableAnnotator implements FijiTableAnnotator {
   ...
   * private for testing.
   *
   * @param table HBaseFijiTable in which the specified column lives. This will be used for
   ...
   * FijiTableAnnotator meta table key. This method is package private for testing.
   *
   * @param table HBaseFijiTable in which the column from the specified key lives. This will be used
  ...
  static FijiColumnName columnFromMetaTableKey(
    ...
    return translator.toFijiColumnName(hbaseColumn);
  }
  ...
  /**
   * Initialize a new HBaseFijiTableAnnotator for the given table.
   *
   * @param table the table served by this ColumnAnnotator.
   */
  public HBaseFijiTableAnnotator(
      final HBaseFijiTable table
  ) {
    mTable = (HBaseFijiTable) table.retain();
  ...
  public void close() throws IOException {
    requireAndSetState(State.OPEN, State.CLOSED, "close an HBaseFijiTableAnnotator");
    mTable.release();
  }
