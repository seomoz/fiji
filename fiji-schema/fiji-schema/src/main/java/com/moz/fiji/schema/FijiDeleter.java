...
/**
 * Interface for performing deletes on a Fiji table.
 *
 * <p>FijiDeleter provides methods for deleting data from a Fiji table.</p>
 *
 * <p>Delete all data on the given row in the given column (column family:column qualifier).</p>
 * <pre>
 *   final FijiDeleter deleter = myFijiTable.openTableWriter();
 ...
 * </pre>
 *
 * This interface is bundled within the {@link FijiTableWriter} interface.
 *
...
@Inheritance.Sealed
public interface FijiDeleter extends Closeable, Flushable {
  /**
