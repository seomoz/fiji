...
/**
 * A FijiColumnFilter that only allows qualifiers that match a given regular expression.
 */
@ApiAudience.Public
@ApiStability.Evolving
public final class RegexQualifierColumnFilter extends FijiColumnFilter {
  ...
  public Filter toHBaseFilter(FijiColumnName fijiColumnName, Context context) throws IOException {
    HBaseColumnName columnName = context.getHBaseColumnName(fijiColumnName);
