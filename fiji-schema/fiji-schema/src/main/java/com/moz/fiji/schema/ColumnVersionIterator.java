...
public final class ColumnVersionIterator<T>
  ...
  private final FijiRowData mRow;
  private final String mFamily;
  private final String mQualifier;
  private final FijiPager mVersionPager;
   ...
   * </p>
   *
   * @param row Fiji row data with paging enabled on the specified map-type family.
   ...
   */
  public ColumnVersionIterator(FijiRowData row, String family, String qualifier, int pageSize)
      throws IOException {
  ...
  private Entry<Long, T> getNext() throws IOException {
    while ((mPage == null) || !mPage.hasNext()) {
      ...
      final FijiRowData rowPage = mVersionPager.next(this.mPageSize);
