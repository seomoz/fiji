...
import com.moz.fiji.schema.impl.SpecificCellDecoder;
import com.moz.fiji.schema.layout.CellSpec;
import com.moz.fiji.schema.layout.FijiTableLayout;

/**
 * Factory for Fiji cell decoders using SpecificCellDecoder to handle record-based schemas.
 */
@ApiAudience.Framework
@ApiStability.Evolving
public final class SpecificCellDecoderFactory implements FijiCellDecoderFactory {
  /** Singleton instance. */
