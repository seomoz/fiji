...
public final class HBaseQualifierPager implements Iterator<String[]>, Closeable {
  ...
  public String[] next(int pageSize) {
    ...
    final FijiColumnFilter filter = Filters.and(
        ...
        new FijiPaginationFilter(pageSize),  // Select at most 1 version per qualifier
    ...
    try {
      ...
      for (int i = 0; i < kvs.length; ++i) {
        ...
        final FijiColumnName fijiColumn = translator.toFijiColumnName(hbaseColumn);
        qualifiers[i] = fijiColumn.getQualifier();
      }
