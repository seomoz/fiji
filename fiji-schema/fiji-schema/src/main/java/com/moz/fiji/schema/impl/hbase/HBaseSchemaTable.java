...
import static com.moz.fiji.schema.util.ByteStreamArray.longToVarInt64;
...
import com.moz.fiji.schema.util.ByteStreamArray.EncodingException;
 ...
 */
@ApiAudience.Private
public final class HBaseSchemaTable implements FijiSchemaTable {
  ...
  /** Schema hash cache. */
  private final SchemaHashCache mHashCache = new FijiSchemaTable.SchemaHashCache();
  ...
  public static HTableInterface newSchemaHashTable(
    ...
    return factory.create(conf,
        FijiManagedHBaseTableName.getSchemaHashTableName(fijiURI.getInstance()).toString());
  }
  ...
  public static HTableInterface newSchemaIdTable(
    ...
    return factory.create(
        conf,
        FijiManagedHBaseTableName.getSchemaIdTableName(fijiURI.getInstance()).toString());
  }
  ...
  public static void install(
    ...
    final HBaseSchemaTable schemaTable = new HBaseSchemaTable(fijiURI, conf, tableFactory);
    try {
