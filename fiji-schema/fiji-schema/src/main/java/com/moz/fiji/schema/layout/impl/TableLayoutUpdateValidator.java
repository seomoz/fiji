...
import com.moz.fiji.schema.util.AvroUtils;
import com.moz.fiji.schema.util.AvroUtils.SchemaCompatibilityType;
import com.moz.fiji.schema.util.AvroUtils.SchemaPairCompatibility;
import com.moz.fiji.schema.util.AvroUtils.SchemaSetCompatibility;
...
public final class TableLayoutUpdateValidator {
   ...
   * the given Fiji instance.
   *
   * @param fiji the Fiji instance from which to get schema definitions.
   * @throws IOException in case of an error reading from the schema table.
   */
  public TableLayoutUpdateValidator(Fiji fiji) throws IOException {
    mFiji = fiji;
   ...
   */
  public void validate(FijiTableLayout reference, FijiTableLayout layout) throws IOException {
