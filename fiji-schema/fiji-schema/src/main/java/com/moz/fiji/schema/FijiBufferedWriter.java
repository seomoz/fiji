...
/**
 * Interface for performing batch operations on a Fiji Table.  Buffered operations are stored in
 ...
 * Accessible via {@link FijiTable#getWriterFactory()} then
 * {@link FijiWriterFactory#openBufferedWriter()}.
 */
@ApiAudience.Public
@ApiStability.Evolving
@Inheritance.Sealed
public interface FijiBufferedWriter extends FijiPutter, FijiDeleter {
  /**
