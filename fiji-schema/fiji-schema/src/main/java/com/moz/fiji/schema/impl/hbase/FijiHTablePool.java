...
//* table name.
//*
//* You may construct a FijiHTablePool using the constructor
//* {@link FijiHTablePool(String, com.moz.fiji.schema.impl.HTableInterfaceFactory). Note that the
...
//*/
//@ApiAudience.Private
//public final class FijiHTablePool implements Closeable {
...
//
//  /** The name of the fiji table we're generating tables for. */
...
//
//  /** The Fiji instance backing the table. */
...
//   * @param fiji The HBaseFiji instance backing these tables.
//   * @param tableFactory A factory to create the underlying HTableInterfaces.  This factory must
//   *     create HTables.
//   */
//  public FijiHTablePool(String name, HBaseFiji fiji, HTableInterfaceFactory tableFactory) {
//    mTableName = name;
...
//    try {
//      if (mPool.isClosed()) {
//        throw new FijiIOException("Attempting to close an already closed table pool.");
//      }
...
//      final HTableInterface hTable = mHTableFactory.create(mFiji.getConf(), mHBaseTableName);
...
//        throw new FijiIOException("Could not confirm state of " + obj.toString(), ioe);
//      }
//    }
//  }
//
...
//        .add("fiji_uri", mFiji.getURI().toString())
...
//      } catch (Exception e) {
//        throw new FijiIOException("Error when returning a PoolHTable to its pool.", e);
//      }
//    }
//
//    @Override
