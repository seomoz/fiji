...
public final class AndRowFilter extends OperatorRowFilter {
   ...
   * @deprecated Use {@link Filters#and(FijiRowFilter...)}.
   */
  @Deprecated
  public AndRowFilter(List<? extends FijiRowFilter> filters) {
    super(OperatorRowFilter.Operator.AND, filters.toArray(new FijiRowFilter[filters.size()]));
  }
   ...
   */
  @Deprecated
  public AndRowFilter(FijiRowFilter... filters) {
  ...
  public static final class AndRowFilterDeserializer implements FijiRowFilterDeserializer {
    /** {@inheritDoc} */
    @Override
