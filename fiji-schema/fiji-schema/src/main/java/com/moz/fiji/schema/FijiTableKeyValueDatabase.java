 ...
 *   {@link FijiTableAnnotator}.
 * </p>
 *
 * @param <T> the type of the class implementing FijiTableKeyValueDatabase, to be used
 *     in putValue()'s return type.
 */
@ApiAudience.Framework
@ApiStability.Evolving
@Inheritance.Sealed
public interface FijiTableKeyValueDatabase<T extends FijiTableKeyValueDatabase<T>> {
   ...
   *
   * @param table The fiji table that this key-value pair will be set with.
   * @param key The key to associate with the specified value.
   * @param value The value to associate with the specified key.
   * @return The same FijiTableKeyValueDatabase.
   ...
   *
   * @param table The fiji table associated with the metadata.
