 ...
 *       even if this filter is attached to a subset of the columns only in a FijiDataRequest.
...
public final class StripValueColumnFilter extends FijiColumnFilter {
