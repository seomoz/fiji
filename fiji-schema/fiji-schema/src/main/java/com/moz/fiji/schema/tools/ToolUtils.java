...
public final class ToolUtils {
   ...
   * @throws IOException on I/O error.
   */
  public static EntityId parseFijiRowKey(
      String rowKeySpec, EntityIdFactory factory, FijiTableLayout layout)
      throws IOException {
  ...
  public static Map<FamilyLayout, List<String>> getMapTypeFamilies(
      List<FijiColumnName> rawColumnNames,
   ...
   */
  public static FijiDataRequest getDataRequest(
      Map<FamilyLayout, List<String>> mapTypeFamilies,
      Map<FamilyLayout, List<ColumnLayout>> groupTypeColumns,
      int maxVersions,
      long minTimestamp,
    ...
    final FijiDataRequestBuilder.ColumnsDef colBuilder =
