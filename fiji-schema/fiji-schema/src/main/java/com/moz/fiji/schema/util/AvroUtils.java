...
public final class AvroUtils {
   ...
   * UIDs using the given FijiSchemaTable.
   *
   * @param schemaTable FijiSchemaTable with which to resolve schema UIDs.
  ...
  public static SchemaPairCompatibility checkReaderWriterCompatibility(
    ...
    switch (compatibility) {
      ...
      default: throw new InternalFijiError("Unknown compatibility: " + compatibility);
    }
    ...
    private SchemaCompatibilityType calculateCompatibility(
      ...
      if (reader.getType() == writer.getType()) {
        switch (reader.getType()) {
          ...
          default: {
            throw new InternalFijiError("Unknown schema type: " + reader.getType());
          }
        }
