 ...
 * notifications through calls to {@link #update(FijiTableLayout)} that a new
 * {@link FijiTableLayout} is available for the table.
 * <p>
...
public interface LayoutConsumer {
   ...
   *
   * @param layout the most recent layout of the Fiji table.
   * @throws IOException in case of an error updating.
   */
  void update(FijiTableLayout layout) throws IOException;
