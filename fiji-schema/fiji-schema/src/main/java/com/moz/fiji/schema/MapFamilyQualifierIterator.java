...
public final class MapFamilyQualifierIterator
  ...
  private final FijiPager mQualifierPager;
   ...
   */
  public MapFamilyQualifierIterator(FijiRowData row, String family, int pageSize)
      throws IOException {
  ...
  private String getNext() {
    while ((mPage == null) || !mPage.hasNext()) {
      ...
      final FijiRowData rowPage = mQualifierPager.next(this.mPageSize);
