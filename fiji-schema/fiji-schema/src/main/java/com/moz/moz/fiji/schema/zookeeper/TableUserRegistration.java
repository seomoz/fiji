...
public final class TableUserRegistration implements Closeable {
  ...
  /**
   * Create a table registration for the table with the provided FijiURI. The actual
   ...
   */
  public TableUserRegistration(CuratorFramework zkClient, FijiURI tableURI, String userID) {
    mUserID = userID;
    mTableURI = tableURI;
    mZKClient = zkClient;
