...
public final class Filters {
   ...
   */
  public static FijiRowFilter or(FijiRowFilter... filters) {
   ...
   */
  public static FijiRowFilter and(FijiRowFilter... filters) {
   ...
   */
  public static FijiColumnFilter or(FijiColumnFilter... filters) {
   ...
   */
  public static FijiColumnFilter and(FijiColumnFilter... filters) {
