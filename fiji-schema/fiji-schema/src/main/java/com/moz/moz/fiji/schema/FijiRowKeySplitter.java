...
/**
 * Utility class for splitting the Fiji row key space.
 */
@ApiAudience.Framework
@ApiStability.Evolving
public final class FijiRowKeySplitter {
  private static final Logger LOG = LoggerFactory.getLogger(FijiRowKeySplitter.class);

  /** No public constructor since this is a factory class. */
  private FijiRowKeySplitter() {}

  /**
   * Creates an instance of FijiRowKeySplitter for the default MD5 hash algorithm.
   *
   * @return a new splitter for Fiji row keys.
   */
  public static FijiRowKeySplitter get() {
    return new FijiRowKeySplitter();
  }
