...
/**
 * Interface for performing increments on a Fiji table.
 *
 * <p>
 *   FijiIncrementer provides a method for modifying the value of a counter given
 ...
 *
 * <pre>
 *   final FijiIncrementer incrementer = myFijiTable.openTableWriter();
 *   incrementer.increment(entityId, columnFamily, columnQualifier, amount);
 * </pre>
 *
 * This interface is not used alone but is bundled within {@link FijiTableWriter}.
 */
@ApiAudience.Public
@ApiStability.Evolving
@Inheritance.Sealed
public interface FijiIncrementer extends Closeable, Flushable {
  /**
   * Atomically increments a counter in a fiji table.
   *
   ...
   */
  FijiCell<Long> increment(EntityId entityId, String family, String qualifier, long amount)
      throws IOException;
}
