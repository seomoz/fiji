...
/**
 * Manages setting, retrieving, and searching key value annotations for a FijiTable.
 *
 * <p>
...
@Inheritance.Sealed
public interface FijiTableAnnotator extends Closeable {

  /**
   * Regex describing restrictions on FijiTableAnnotator keys.
   ...
   * @throws IOException in case of an error writing to the meta table.
   */
  void setColumnAnnotation(FijiColumnName column, String key, String value) throws IOException;
   ...
   * @throws IOException in case of an error writing to the meta table.
   */
  void setColumnAnnotations(FijiColumnName column, Map<String, String> kvs) throws IOException;
   ...
   * @throws IOException in case of an error writing to the meta table.
   */
  void removeColumnAnnotation(FijiColumnName column, String exactKey) throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Set<String> removeColumnAnnotationsStartingWith(FijiColumnName column, String prefix)
      throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Set<String> removeColumnAnnotationsContaining(FijiColumnName column, String substring)
      throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Set<String> removeColumnAnnotationsMatching(FijiColumnName column, String pattern)
      throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Set<String> removeAllColumnAnnotations(FijiColumnName column) throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Set<FijiColumnName> removeColumnAnnotationsInFamily(String family, String exactKey)
      throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Map<FijiColumnName, Set<String>> removeColumnAnnotationsInFamilyStartingWith(
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Map<FijiColumnName, Set<String>> removeColumnAnnotationsInFamilyContaining(
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Map<FijiColumnName, Set<String>> removeColumnAnnotationsInFamilyMatching(
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Map<FijiColumnName, Set<String>> removeAllColumnAnnotationsInFamily(String family)
      throws IOException;
   ...
   * @throws IOException in case of an error reading or writing to the meta table.
   */
  Map<FijiColumnName, Set<String>> removeAllColumnAnnotations() throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  String getColumnAnnotation(FijiColumnName column, String exactKey) throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<String, String> getColumnAnnotationsStartingWith(FijiColumnName column, String prefix)
      throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<String, String> getColumnAnnotationsContaining(FijiColumnName column, String substring)
      throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<String, String> getColumnAnnotationsMatching(FijiColumnName column, String pattern)
      throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<String, String> getAllColumnAnnotations(FijiColumnName column) throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<FijiColumnName, String> getColumnAnnotationsInFamily(String family, String exactKey)
      throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<FijiColumnName, Map<String, String>> getColumnAnnotationsInFamilyMatching(
      String family, String pattern) throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<FijiColumnName, Map<String, String>> getAllColumnAnnotationsInFamily(String family)
      throws IOException;
   ...
   * @throws IOException in case of an error reading from the meta table.
   */
  Map<FijiColumnName, Map<String, String>> getAllColumnAnnotations() throws IOException;
