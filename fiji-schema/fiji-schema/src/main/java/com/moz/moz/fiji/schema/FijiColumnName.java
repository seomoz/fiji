...
/**
 * A Fiji column name is composed of one or two parts: a family and a qualifier.
...
@ApiAudience.Public
@ApiStability.Stable
public final class FijiColumnName implements Comparable<FijiColumnName> {

  /**
   * Create a new FijiColumnName from a family and qualifier.
   *
   * @param family Family of the Fiji column for which to create a name.
   * @param qualifier Qualifier of the Fiji column for which to create a name.
   * @return a new FijiColumnName from the given family and qualifier.
   */
  public static FijiColumnName create(
      final String family,
      final String qualifier
  ) {
    return new FijiColumnName(family, qualifier);
  }

  /**
   * Create a new FijiColumnName from a column's full name.
   *
   * <p>
   ...
   * </p>
   *
   * @param fullName The full name of the Fiji column for which to create a name.
   * @return a new FijiColumnName from the given full name.
   */
  public static FijiColumnName create(
      final String fullName
  ) {
    return new FijiColumnName(fullName);
  }
   ...
   *
   * @param fullName The name of a fiji column "family:qualifier".
   * @deprecated FijiColumnName constructors are deprecated. Please use the factory method
   *     {@link FijiColumnName#create(String)}. This constructor will become private in the future.
   */
  @Deprecated
  public FijiColumnName(String fullName) {
   ...
   *
   * @param family The fiji column family.
   * @param qualifier The fiji column qualifier: null means unqualified.
   *   Empty string qualifiers are forced to be null.
   * @deprecated FijiColumnName constructors are deprecated. Please use the factory method
   *     {@link FijiColumnName#create(String, String)}. This constructor will become private in
   *     the future.
   */
  @Deprecated
  public FijiColumnName(String family, String qualifier) {
  ...
  public boolean equals(Object otherObj) {
    ...
    final FijiColumnName other = (FijiColumnName) otherObj;
  ...
  /** {@inheritDoc} */
  @Override
  public int compareTo(FijiColumnName otherObj) {
