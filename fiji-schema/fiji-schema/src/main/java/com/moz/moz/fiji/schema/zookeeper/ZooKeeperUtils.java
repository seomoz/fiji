...
import com.moz.fiji.commons.ReferenceCountedCache;
...
public final class ZooKeeperUtils {
   ...
   */
  public static File getSchemaTableLock(FijiURI instanceURI) {
    return new File("/fiji/" + instanceURI.getInstance());
  }
  ...
  /**
   * Return a {@link com.moz.fiji.schema.util.Lock} instance which must be aquired before updating a
   * table layout.
   *
   * @param zkClient connection to ZooKeeper.
   * @param tableURI of table to be updated.
   * @return a {@link com.moz.fiji.schema.util.Lock} for updating the table's layout.
   */
  ...
  /**
   * Gets a users tracker for a Fiji instance.
   *
   * @param zkClient connection to ZooKeeper.
   * @param instanceURI of Fiji instance whose users to track.
   * @return a UsersTracker for the table.
   */
  ...
  /**
   * Takes any Exception and rethrows it if it is an IOException, or wraps it in a FijiIOException
   * and throws that.
   *
   * @param e exception to be wrapped.
   * @throws IOException if the provided exception is an IOException.
   * @throws FijiIOException for any other Exception type.
   */
