...
/**
 * Thrown when an invalid Fiji layout is encountered.  Possible reasons why a layout may be
 * invalid include:
 * <ul>
 ...
 *       {@link com.moz.fiji.schema.layout.FijiTableLayout FijiTableLayout}
...
public class InvalidLayoutException extends IOException {
   ...
   * @param reason A message describing the reason the layout is invalid.
   */
  public InvalidLayoutException(FijiTableLayout tableLayout, String reason) {
