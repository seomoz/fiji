...
public final class OrColumnFilter extends OperatorColumnFilter {
   ...
   */
  OrColumnFilter(List<? extends FijiColumnFilter> filters) {
    super(Operator.OR, filters.toArray(new FijiColumnFilter[filters.size()]));
  }
   ...
   *     Nulls are filtered out.
   */
  OrColumnFilter(FijiColumnFilter... filters) {
