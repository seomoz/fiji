...
/**
 * Specification of read properties applied when decoding cells from a column in a Fiji table.
 *
 * <p>
 *   This class provides several factory methods to specify read properties applied when decoding
 *   a column in a Fiji table.
 * </p>
 *
 * <p>
 ...
 *   {@link com.moz.fiji.schema.FijiDataRequest} requires it. Do not rely on Java serialization, it will
