...
import com.moz.fiji.schema.avro.TestComplexRecord;
import com.moz.fiji.schema.avro.TestRecord;

/** Tests the serialization and deserialization of FijiRowFilters. */
public class TestFijiRowFilterSerialization {
  @Test
  ...
  private void runTest(FijiRowFilter original) throws Exception {
