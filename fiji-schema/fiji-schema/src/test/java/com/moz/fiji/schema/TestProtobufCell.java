...
import com.moz.fiji.proto.test.TestProtocolBuffers.AnotherOne;
import com.moz.fiji.proto.test.TestProtocolBuffers.Record;
...
public class TestProtobufCell extends FijiClientTest {
  ...
  private static final String PROTOBUF_LAYOUT =
      "com.moz.fiji/schema/layout/TestProtobufCell.layout.json";
  ...
  public void setupTest() throws IOException {
    mFiji = getFiji();
    mFiji.createTable(FijiTableLayouts.getLayout(PROTOBUF_LAYOUT));
    ...
    try {
      ...
      try {
        ...
        Assert.assertTrue(ioe.getMessage().contains(
            "Protocol buffer of class 'com.moz.fiji.proto.test.TestProtocolBuffers$AnotherOne' "
            + "(message name 'test.AnotherOne') "
            + "does not match expected class 'com.moz.fiji.proto.test.TestProtocolBuffers$Record' "
