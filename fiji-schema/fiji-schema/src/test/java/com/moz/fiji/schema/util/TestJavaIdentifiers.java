...
public class TestJavaIdentifiers {
  ...
  public void testIsValidClassName() {
    assertTrue(JavaIdentifiers.isValidClassName("com.moz.fiji.schema.Foo"));
    assertFalse(JavaIdentifiers.isValidClassName("com.moz.fiji.schema..Foo"));
    assertTrue(JavaIdentifiers.isValidClassName("com.moz.fiji.schema.Foo$Bar"));
