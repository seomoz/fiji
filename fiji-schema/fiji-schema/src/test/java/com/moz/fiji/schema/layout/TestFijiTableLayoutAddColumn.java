...
public class TestFijiTableLayoutAddColumn {
  private static final Logger LOG = LoggerFactory.getLogger(TestFijiTableLayoutAddColumn.class);
  ...
  public void testAddColumn() throws Exception {
    final FijiTableLayout layout1 = FijiTableLayout.newLayout(getLayoutV1Desc());
    {
    ...
    final FijiTableLayout layout2 = FijiTableLayout.createUpdatedLayout(getLayoutV2Desc(), layout1);
    {
    ...
    final FijiTableLayout layout3 = FijiTableLayout.createUpdatedLayout(getLayoutV3Desc(), layout2);
    {
    ...
    final FijiTableLayout layout4 = FijiTableLayout.createUpdatedLayout(getLayoutV4Desc(), layout3);
    {
