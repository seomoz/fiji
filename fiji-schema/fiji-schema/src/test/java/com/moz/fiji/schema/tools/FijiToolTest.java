...
/**
 * Base class providing some helpers around running Fiji CLI tools. The tool output (both
 ...
 */
public abstract class FijiToolTest extends FijiClientTest {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(FijiToolTest.class);
