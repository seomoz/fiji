...
public class TestAllTypesSchema {
  ...
  public void testAllTypesSchema() throws IOException {
    ...
    // client packages of FijiSchema for tests to ensure that all Avro types behave as expected.
    // This serves as a warning that edits to this schema are done with care.
    FijiTableLayout layout = FijiTableLayout.newLayout(
      FijiTableLayouts.getLayout("com.moz.fiji/schema/layout/all-types-schema.json"));
    Map<String, FijiTableLayout.LocalityGroupLayout.FamilyLayout> familyMap =
        layout.getFamilyMap();
    ...
    Map<String, FijiTableLayout.LocalityGroupLayout.FamilyLayout.ColumnLayout> primitiveColumnMap =
    ...
    Map<String, FijiTableLayout.LocalityGroupLayout.FamilyLayout.ColumnLayout> complexColumnMap =
