...
public class TestHBaseFijiURI {
  @Test
  public void testClusterIdentifier() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234").build();
    assertEquals("fiji-hbase", uri.getScheme());
  ...
  public void testFijiInstanceUri() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234/instance").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals("zkhost", uri.getZookeeperQuorum().get(0));
    assertEquals(1234, uri.getZookeeperClientPort());
  ...
  public void testSingleHost() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234/instance/table/col").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals("zkhost", uri.getZookeeperQuorum().get(0));
    assertEquals(1234, uri.getZookeeperClientPort());
    assertEquals("instance", uri.getInstance());
  ...
  public void testSingleHostGroupColumn() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://zkhost:1234/instance/table/family:qualifier").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals("zkhost", uri.getZookeeperQuorum().get(0));
    assertEquals(1234, uri.getZookeeperClientPort());
    assertEquals("instance", uri.getInstance());
  ...
  public void testSingleHostDefaultInstance() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234/default/table/col").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals("zkhost", uri.getZookeeperQuorum().get(0));
  ...
  public void testSingleHostDefaultPort() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost/instance/table/col").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals(1, uri.getZookeeperQuorum().size());
    assertEquals("zkhost", uri.getZookeeperQuorum().get(0));
  ...
  public void testMultipleHosts() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col").build();
    assertEquals("fiji-hbase", uri.getScheme());
  ...
  public void testMultipleHostsDefaultPort() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://zkhost1,zkhost2/instance/table/col").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals("zkhost1", uri.getZookeeperQuorum().get(0));
    assertEquals("zkhost2", uri.getZookeeperQuorum().get(1));
    assertEquals(FijiURI.DEFAULT_ZOOKEEPER_CLIENT_PORT, uri.getZookeeperClientPort());
  ...
  public void testMultipleHostsDefaultPortDefaultInstance() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://zkhost1,zkhost2/default/table/col").build();
    assertEquals("fiji-hbase", uri.getScheme());
    assertEquals("zkhost1", uri.getZookeeperQuorum().get(0));
    assertEquals("zkhost2", uri.getZookeeperQuorum().get(1));
    assertEquals(FijiURI.DEFAULT_ZOOKEEPER_CLIENT_PORT, uri.getZookeeperClientPort());
  ...
  public void testNoAuthority() {
    try {
      FijiURI.newBuilder("fiji-hbase:///");
      fail("An exception should have been thrown.");
    } catch (FijiURIException kurie) {
      assertEquals("Invalid Fiji URI: 'fiji-hbase:///' : ZooKeeper ensemble missing.",
          kurie.getMessage());
    }
  }
  ...
  public void testMultipleHostsNoParen() {
    try {
      FijiURI.newBuilder("fiji-hbase://zkhost1,zkhost2:1234/instance/table/col");
      fail("An exception should have been thrown.");
    } catch (FijiURIException kurie) {
      assertEquals("Invalid Fiji URI: 'fiji-hbase://zkhost1,zkhost2:1234/instance/table/col' : "
  ...
  public void testMultipleHostsMultiplePorts() {
    try {
      FijiURI.newBuilder("fiji-hbase://zkhost1:1234,zkhost2:2345/instance/table/col");
      fail("An exception should have been thrown.");
    } catch (FijiURIException kurie) {
      assertEquals("Invalid Fiji URI: 'fiji-hbase://zkhost1:1234,zkhost2:2345/instance/table/col'"
  ...
  public void testMultipleColumns() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://zkhost1,zkhost2/default/table/col1,col2").build();
    assertEquals("zkhost1", uri.getZookeeperQuorum().get(0));
    assertEquals("zkhost2", uri.getZookeeperQuorum().get(1));
    assertEquals(FijiURI.DEFAULT_ZOOKEEPER_CLIENT_PORT, uri.getZookeeperClientPort());
    assertEquals("default", uri.getInstance());
  ...
  public void testExtraPath() {
    try {
      FijiURI.newBuilder("fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col/extra");
      fail("An exception should have been thrown.");
    } catch (FijiURIException kurie) {
      assertEquals("Invalid Fiji URI: 'fiji-hbase://(zkhost1,zkhost2):1234/"
  ...
  public void testURIWithQuery() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col?query").build();
    assertEquals("zkhost1", uri.getZookeeperQuorum().get(0));
    assertEquals("zkhost2", uri.getZookeeperQuorum().get(1));
    assertEquals(1234, uri.getZookeeperClientPort());
    assertEquals("instance", uri.getInstance());
  ...
  public void testURIWithFragment() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col#frag").build();
    assertEquals("zkhost1", uri.getZookeeperQuorum().get(0));
    assertEquals("zkhost2", uri.getZookeeperQuorum().get(1));
    assertEquals(1234, uri.getZookeeperClientPort());
    assertEquals("instance", uri.getInstance());
  ...
  public void testResolution() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234/.unset").build();
    final FijiURI resolved = uri.resolve("testinstance");
    assertEquals("testinstance", resolved.getInstance());
  }
  ...
  public void testResolutionColumn() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost/instance/table").build();
  ...
  public void testInvalidResolution() {
    ...
    try {
      ...
      assertEquals("Invalid Fiji URI: 'fiji-hbase://zkhost:1234/instance/table/col/extra' : "
  ...
  public void testToString() {
    String uri = "fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col/";
    assertEquals(uri, FijiURI.newBuilder(uri).build().toString());
    uri = "fiji-hbase://zkhost1:1234/instance/table/col/";
    assertEquals(uri, FijiURI.newBuilder(uri).build().toString());
    uri = "fiji-hbase://zkhost:1234/instance/table/col1,col2/";
    assertEquals(uri, FijiURI.newBuilder(uri).build().toString());
    uri = "fiji-hbase://zkhost:1234/.unset/table/col/";
    assertEquals(uri, FijiURI.newBuilder(uri).build().toString());
  }
  ...
  public void testNormalizedQuorum() {
    ...
    FijiURI reversedQuorumUri =
        FijiURI.newBuilder("fiji-hbase://(zkhost2,zkhost1):1234/instance/table/col/").build();
  ...
  public void testOrderedColumns() {
    FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col1,col2/").build();
    FijiURI reversedColumnURI =
        FijiURI.newBuilder("fiji-hbase://(zkhost1,zkhost2):1234/instance/table/col2,col1/").build();
  ...
  public void testFijiURIBuilderFromInstance() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234/.unset/table").build();
  ...
  public void testFijiURIBuilderWithInstance() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost:1234/instance1/table").build();
  ...
  public void testSetColumn() {
    FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost/instance/table/").build();
    assertTrue(uri.getColumns().isEmpty());
    uri =
  ...
  public void testTrailingUnset() {
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost/.unset/table/.unset").build();
    FijiURI result = FijiURI.newBuilder(uri).withTableName(".unset").build();
    assertEquals("fiji-hbase://zkhost:2181/", result.toString());
  }

  @Test
  public void testEscapedMapColumnQualifier() {
    final FijiURI uri =
        FijiURI.newBuilder("fiji-hbase://zkhost/instance/table/map:one%20two").build();
  ...
  public void testConstructedUriIsEscaped() {
    ...
    final FijiURI uri = FijiURI.newBuilder("fiji-hbase://zkhost/instance/table/")
        .addColumnName(FijiColumnName.create("map:one two")).build();
    assertEquals("fiji-hbase://zkhost:2181/instance/table/map:one%20two/", uri.toString());
  }
