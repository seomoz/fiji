...
import com.moz.fiji.schema.impl.hbase.HBaseQualifierPager;
import com.moz.fiji.schema.layout.FijiTableLayouts;

public class TestHBaseQualifierPager extends FijiClientTest {
  ...
  public void testQualifiersPager() throws IOException {
    ...
    final HBaseQualifierPager pager =
        new HBaseQualifierPager(
            eid, dataRequest, (HBaseFijiTable) mTable, FijiColumnName.create("jobs"));
    try {
