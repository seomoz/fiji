...
public class TestingZooKeeperFactory implements ZooKeeperFactory {
   ...
   *
   * Lazily started when the first test requests the ZooKeeper ensemble for a fake Fiji instance.
   *
  ...
  /** {@inheritDoc} */
  @Override
  public String getZooKeeperEnsemble(FijiURI clusterURI) {
  ...
  /**
   * Extracts the ID of the fake cluster instance from a {@link FijiURI}.  If the URI does not
   ...
   */
  public static String getFakeClusterID(FijiURI uri) {
