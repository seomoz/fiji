...
public class TestSchemaTableTool extends FijiToolTest {
  ...
  private FijiSchemaTable mTable = null;
  ...
  public void testGetSchemaById() throws Exception {
    final long simpleSchemaId = getFiji().getSchemaTable().getOrCreateSchemaId(mSimpleSchema);
    assertEquals(BaseTool.SUCCESS, runTool(new SchemaTableTool(),
        getFiji().getURI().toString(),
