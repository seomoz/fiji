...
import com.moz.fiji.schema.layout.impl.TestZooKeeperMonitor.QueueingLayoutUpdateHandler;
import com.moz.fiji.schema.layout.impl.TestZooKeeperMonitor.QueueingUsersUpdateHandler;
import com.moz.fiji.schema.layout.impl.ZooKeeperClient;
import com.moz.fiji.schema.layout.impl.ZooKeeperMonitor;
...
public class TestTableLayoutTracker extends ZooKeeperTest {
  ...
  public void testLayoutTrackerUpdatesCache() throws Exception {
    final FijiURI tableURI = FijiURI.newBuilder().withInstanceName("i").withTableName("t").build();
