...
public class TestFormattedEntityId extends FijiClientTest {
  ...
  @Test
  public void testSuppressKeyMaterializationInFiji() throws IOException {
    final Fiji fiji = getFiji(); // owned by FijiClientTest
    fiji.createTable(FijiTableLayouts.getLayout(FijiTableLayouts.HASHED_FORMATTED_RKF));
    ...
    try {
      ...
      try {
        ...
        final FijiRowData result = reader.get(table.getEntityId("x"), dataRequest);
  ...
  public void testTooManyComponentsFormattedEntityId() {
    ...
    try {
      ...
      assertEquals("Too many components in fiji Row Key", eie.getMessage());
    }
  ...
  public void testWrongComponentTypeFormattedEntityId() {
    ...
    try {
      ...
      assertEquals("Invalid type for component 1 at index 1 in fijiRowKey", eie.getMessage());
    }
  }
  ...
  public void testUnexpectedNullFormattedEntityId() {
    ...
    try {
      ...
      assertEquals("Too few components in fiji Row key", eie.getMessage());
    }
  }
  ...
  public void testNullFormattedEntityId() {
    ...
    try {
      ...
      assertTrue(eie.getMessage().contains(
          "Unexpected null component in fiji row key.Expected at least 1 non-null components"));
    }
  }
