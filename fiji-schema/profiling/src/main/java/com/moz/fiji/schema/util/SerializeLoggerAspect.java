...
/**
 * This aspect is invoked after the main function in any Fiji tool. It
...
public final class SerializeLoggerAspect {
   ...
   */
  private static final String PROFILE_OUTPUT_DIR = "/tmp/fijistats_";
   ...
   * Example filename: /tmp/fijistats_20130617_1634_31925@DeepThought_VersionTool.csv where,
   ...
   */
  @Pointcut("execution(* com.moz.fiji.schema.tools.BaseTool.toolMain(..))")
