...
class TestAvroValueParser
  ...
  def testLayout(): Unit = {
    val layoutSchemas = schemaParser.parseSequence("""
      |enum com.moz.fiji.schema.avro.CompressionType { NONE, GZ, LZO, SNAPPY }
      |enum com.moz.fiji.schema.avro.SchemaType { INLINE, CLASS, COUNTER, AVRO, RAW_BYTES, PROTOBUF }
      |enum com.moz.fiji.schema.avro.SchemaStorage { HASH, UID, FINAL }
      |
      |record com.moz.fiji.schema.avro.AvroSchema {
      |  union { null, long } uid = null;
      |  union { null, string } json = null;
      |}
      |
      |enum com.moz.fiji.schema.avro.AvroValidationPolicy { STRICT, DEVELOPER, SCHEMA_1_0, NONE }
      |
      |record com.moz.fiji.schema.avro.CellSchema {
      ...
      |}
      |
      |record com.moz.fiji.schema.avro.ColumnDesc {
      |  int id = 0;
      |  string name;
      ...
      |}
      |
      |record com.moz.fiji.schema.avro.FamilyDesc {
      |  int id = 0;
      |  string name;
      |  array<string> aliases = [];
      |  boolean enabled = true;
      ...
      |}
      |
      |enum com.moz.fiji.schema.avro.BloomType { NONE, ROW, ROWCOL }
      |
      |record com.moz.fiji.schema.avro.LocalityGroupDesc {
      |  int id = 0;
      |  string name;
      |  array<string> aliases = [];
      |  boolean enabled = true;
      ...
      |}
      |
      |enum com.moz.fiji.schema.avro.HashType { MD5 }
      |enum com.moz.fiji.schema.avro.RowKeyEncoding { RAW, HASH, HASH_PREFIX, FORMATTED }
      |
      |record com.moz.fiji.schema.avro.HashSpec {
      |  HashType hash_type = HashType(MD5);
      |  int hash_size = 16;
      |  boolean suppress_key_materialization = false;
      |}
      |
      |record com.moz.fiji.schema.avro.RowKeyFormat {
      |  RowKeyEncoding encoding;
      |  union { null, HashType } hash_type = null;
      |  int hash_size = 0;
      |}
      |
      |enum com.moz.fiji.schema.avro.ComponentType { STRING, INTEGER, LONG }
      |
      |record com.moz.fiji.schema.avro.RowKeyComponent {
      |  string name;
      |  ComponentType type;
      |}
      |
      |record com.moz.fiji.schema.avro.RowKeyFormat2 {
      |  RowKeyEncoding encoding;
      ...
      |}
      |
      |record com.moz.fiji.schema.avro.TableLayoutDesc {
      |  string name;
    ...
    val layoutSchema = schemaParser.get("com.moz.fiji.schema.avro.TableLayoutDesc")
    ...
    val layoutDesc: GenericData.Record = AvroValueParser.parse(
        text="""
          |com.moz.fiji.schema.avro.TableLayoutDesc {
          |  name = "table_name"
