  ...
  public void testBooleanInvalid() {
    try {
      ...
      assertEquals(
          ...
          + "'com.moz.fiji.common.flags.TestPrimitiveNativeFlag$TestObject.flagBoolean'.",
          ifve.getMessage());
    }
  }
  ...
  public void testShortOverflow() {
    try {
      ...
      assertEquals(
          ...
          + "'com.moz.fiji.common.flags.TestPrimitiveNativeFlag$TestObject.flagShort'.",
          ifve.getMessage());
    }
  }
  ...
  public void testDoubleNull() {
    try {
      ...
      assertEquals(
          ...
          + "declared in 'com.moz.fiji.common.flags.TestPrimitiveNativeFlag$TestObject.flagDouble'.",
          ifve.getMessage());
    }
  }
  ...
  public void testDoubleInvalid() {
    try {
      ...
      assertEquals(
          ...
          + "'com.moz.fiji.common.flags.TestPrimitiveNativeFlag$TestObject.flagDouble'.",
          ifve.getMessage());
    }
  }
}
