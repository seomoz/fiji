...
import com.moz.fiji.common.flags.parser.StringParser;
  ...
  public void testParserMapSubClassConflict() {
    ...
    try {
      ...
      assertEquals(
          ...
          + "'com.moz.fiji.common.flags.TestBaseParsers$CharSequenceParser' "
          + "and 'com.moz.fiji.common.flags.TestBaseParsers$StringSubClassParser'.",
          re.getMessage());
    }
  }
  ...
  public void testParserMapExactConflict() {
    ...
    try {
      ...
      assertEquals(
          ...
          + "'com.moz.fiji.common.flags.parser.StringParser' "
          + "and 'com.moz.fiji.common.flags.parser.StringParser'.",
          re.getMessage());
    }
  }
}
