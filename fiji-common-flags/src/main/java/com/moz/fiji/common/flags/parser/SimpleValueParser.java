...
import com.moz.fiji.common.flags.IllegalFlagOverrideException;
 ...
 * By setting the system property -Dcom.moz.fiji.common.flags.allow.flag.override=true, such flags
...
public abstract class SimpleValueParser<T> implements ValueParser<T> {
  ...
  public static final String ALLOW_FLAG_OVERRIDE_PROPERTY =
      "com.moz.fiji.common.flags.allow.flag.override";
