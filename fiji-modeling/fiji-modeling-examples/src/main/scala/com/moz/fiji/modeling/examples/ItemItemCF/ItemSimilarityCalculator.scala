...
import com.moz.fiji.modeling.framework.ModelPipeConversions
...
class ItemSimilarityCalculator(args: Args) extends ItemItemJob(args) with ModelPipeConversions {
  ...
  // Sort by similarity and create avro records to store in a Fiji table.
  ...
  simRecordsPipe.write(FijiOutput.builder
