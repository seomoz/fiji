...
class MavenProject(object):
    ...
    @property
    def fiji_build_exclusions(self):
        for comment in self._list_comment_nodes():
            text = comment.data.strip()
    ...
    def list_all_immediate_dependencies(
        ...
        Args:
            ...
            force_unresolved: Force the use of unresolved (fiji-build) dependencies.
                For fiji-build generated artifacts, this lists direct dependencies
        ...
        if force_unresolved:
            ...
            exclusions = frozenset(map(artifact.parse_artifact, self.fiji_build_exclusions))
