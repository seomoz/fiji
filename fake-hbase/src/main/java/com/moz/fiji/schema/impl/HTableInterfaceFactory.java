 ...
 *
 * This interface is cloned from FijiSchema as a temporary workaround, to allow FakeHBase
 * to implement it without depending on FijiSchema, and so that FijiSchema may further depend
 * on FakeHBase.
 */
