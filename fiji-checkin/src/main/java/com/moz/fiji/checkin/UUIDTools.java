...
public final class UUIDTools {
  ...
  public static final String UUID_FILE_NAME = ".fiji-bento-uuid";

  /**
   * Gets a UUID for the user by reading the file <code>.fiji-bento-uuid</code> from a directory.
   *
   ...
   * <code>.fiji-bento-uuid</code>. If this file does not exist, generates a
   ...
   *
   * @param directory will be checked for a file named ".fiji-bento-uuid".
   ...
   * <code>.fiji-bento-uuid</code> and will contain one line, which will be the UUID specified.
   *
   * @param directory is where the UUID file <code>.fiji-bento-uuid</code> should be written.
  ...
  /**
   * Writes a randomly generated UUID to the file <code>.fiji-bento-uuid</code> in the specified
