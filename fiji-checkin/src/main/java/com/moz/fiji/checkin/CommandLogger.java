...
public class CommandLogger {
  ...
  private class CommandLoggerThread extends Thread {
     ...
     */
    public CommandLoggerThread(FijiCommand command) {
      mCommand = command;
    }
  ...
  /**
   * Logs the command by POSTing the command to the Fiji checkin server.
   *
   * @param command is the command to log.
   * @param logAsynch determines whether or not to log the command asynchronously.
   */
  public void logCommand(FijiCommand command, boolean logAsynch) {
   ...
   * @param command is the command to log.
   */
  private void doLog(FijiCommand command) {
