...
package com.moz.fiji.checkin.tools;
...
/**
 * <p>A tool that writes the last timestamp the <code>fiji</code> script within a BentoBox was
 * used. The tool will write the current time in milliseconds since the Unix epoch in a file
 * named <code>.fiji-last-used</code> in the user's home directory. If the file already exists,
...
public final class UsageTimestampTool {
  ...
  private static final String TIMESTAMP_FILE_NAME = ".fiji-last-used";

  /**
   * Writes a file containing a timestamp to the specified directory. The file will be named
   * <code>.fiji-last-used</code> and will contain one line, which will be the timestamp specified.
   *   .
   *
   * @param directory is where the timestamp file <code>.fiji-last-used</code> should be written.
  ...
  /**
   * Writes the current time in milliseconds to the file <code>.fiji-last-used</code> in the
