...
package com.moz.fiji.checkin.models;
...
import com.moz.fiji.checkin.VersionInfo;

/**
 * <p>Represents a check-in message that can be sent to a Fiji BentoBox upgrade server. A check-in
 * message contains information such as the version of Fiji BentoBox being used,
 * a unique identifier for the user of Fiji BentoBox, and the last time the <code>fiji</code>
...
public final class UpgradeCheckin implements JsonBeanInterface {
  ...
  private static final String DEFAULT_PROJECT_NAME = "fiji";
  ...
  /**
   * Unix time in milliseconds of the last usage of the <code>fiji</code> command by the user
  ...
  /** The name of the project, "fiji", or "wibi", which differentiates enterprise releases. */
  ...
  /**
   * @return the Unix time in milliseconds of the last usage of the <code>fiji</code> script
  ...
  public static class Builder {
    ...
    /**
     * The usage timestamp for the <code>fiji</code> command to include in the built check-in
     * message.
     */
    ...
    /** Version of Fiji BentoBox in use. */
     ...
     * Unix time in milliseconds of the last usage of the <code>fiji</code> script.
     *
     * @param lastUsedMillis is the Unix time, in milliseconds, of the last usage of the
     *     <code>fiji</code> script included with BentoBox.
    ...
    /**
     * Gets the project name for this project from the expected configuration file.  Returns "fiji"
     ...
     *     "fiji" if the expected config file does not exist.
     */
    ...
    public UpgradeCheckin build()
      ...
      checkNotNull(mLastUsedMillis, "Last usage timestamp for fiji script not supplied to "
