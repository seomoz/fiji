 ...
 * The tool will check the user's home directory for a file named <code>.fiji-bento-uuid</code>.
...
public final class UUIDGenerationTool {
  ...
  /**
   * Writes a randomly generated UUID to the file <code>.fiji-bento-uuid</code> in the home
