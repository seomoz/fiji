...
import com.moz.fiji.checkin.UUIDTools;
import com.moz.fiji.checkin.VersionInfo;

/**
 * <p>
 * Represents a message that can be sent to a Fiji BentoBox upgrade server. A check-in message
 * contains information such as the version of Fiji BentoBox being used, a unique identifier for the
 * user of Fiji BentoBox, and the last time the <code>fiji</code> script included with the
 ...
 *
 * <p>
 * To create a message, use {@link FijiCommand.Builder}. A message can be transformed to JSON by
 * calling {@link #toJSON()}.
 * </p>
 */
public final class FijiCommand implements JsonBeanInterface {
   ...
   */
  private FijiCommand(Builder builder) {
    mType = builder.mType;
  ...
  public boolean equals(Object other) {
    if (!(other instanceof FijiCommand)) {
      return false;
    }
    FijiCommand that = (FijiCommand) other;
   ...
   * {@link FijiCommand} with content equivalent to the values configured. It is an error to attempt
  ...
  public static class Builder {
     ...
     */
    public FijiCommand build() throws IOException {
