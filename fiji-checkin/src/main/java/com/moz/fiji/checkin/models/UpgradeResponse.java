...
/**
 * <p>Represents a response from a Fiji BentoBox upgrade server providing information on new
 * versions available for upgrade. In addition to the content returned by the upgrade server,
 * instances of this class can track a "reminder time," which is the last time a Fiji BentoBox
 ...
 * upgrade server is obtained), or a file containing a JSON record (such as when the local fiji
...
public final class UpgradeResponse {
  ...
  private static final String COMPATIBLE_UPGRADE_MSG_FORMAT = "Version %s of Fiji BentoBox "
  ...
  private static final String INCOMPATIBLE_UPGRADE_MSG_FORMAT = "Version %s of Fiji BentoBox "
