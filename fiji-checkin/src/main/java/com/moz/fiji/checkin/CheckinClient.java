...
import com.moz.fiji.checkin.models.JsonBeanInterface;
import com.moz.fiji.checkin.models.FijiCommand;
import com.moz.fiji.checkin.models.UpgradeCheckin;
import com.moz.fiji.checkin.models.UpgradeResponse;
...
public class CheckinClient implements Closeable {
   ...
   * @throws IOException if there is an error
   */
  public void postCommand(FijiCommand command) throws IOException {
    genericPost(command);
  }
