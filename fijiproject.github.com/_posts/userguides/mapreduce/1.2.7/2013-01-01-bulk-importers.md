...
[`FijiBulkImporter`]({{site.api_mr_1_2_7}}/bulkimport/FijiBulkImporter.html).
...
[`FijiBulkImporter`]({{site.api_mr_1_2_7}}/bulkimport/FijiBulkImporter.html) with the types of the key
...
* `EntityId getEntityId(Object... components)` returns the
  [`EntityId`]({{site.api_schema_1_4_1}}/EntityId.html) for a row in a Fiji table given a string
  identifier.
...
[`FijiTableImportDescriptor`]({{site.api_mrlib_1_1_6}}/bulkimport/FijiTableImportDescriptor.html).
[`FijiTableImportDescriptor`]({{site.api_mrlib_1_1_6}}/bulkimport/FijiTableImportDescriptor.html) is
