...
The [`FijiTableInputFormat`]({{site.api_schema_1_4_1}}/mapreduce/FijiTableInputFormat.html) provides the necessary functionality to read from a Fiji table in a
