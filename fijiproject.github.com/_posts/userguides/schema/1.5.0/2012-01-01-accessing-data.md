...
The [`FijiTableInputFormat`]({{site.api_schema_1_5_0}}/mapreduce/FijiTableInputFormat.html) provides the necessary functionality to read from a Fiji table in a
