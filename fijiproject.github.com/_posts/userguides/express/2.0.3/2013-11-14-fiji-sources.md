...
This specifies the Avro schema with which to read the data in this column.  For more information about Avro schemas, see the [FijiSchema userguide]({{site.userguide_schema_1_4_2}}/managing-data) section on Schema evolution.
