...
<div id="accordion-container">
  <h2 class="accordion-header"> FreshenerContext.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-scoring/raw/fiji-scoring-root-0.14.0/src/main/java/org/fiji/scoring/FreshenerContext.java"> </script>
  </div>
</div>
