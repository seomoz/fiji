...
<div id="accordion-container">
  <h2 class="accordion-header"> FijiFreshnessManager.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-scoring/raw/fiji-scoring-root-0.15.0/src/main/java/org/fiji/scoring/FijiFreshnessManager.java"> </script>
  </div>
</div>
