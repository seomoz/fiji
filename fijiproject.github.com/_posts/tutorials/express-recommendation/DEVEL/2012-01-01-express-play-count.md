...
Data can be read from a Fiji table by using [`FijiInput`](({{site.api_express_devel}}/FijiInput.html).
...
<div id="accordion-container">
  ...
  <div class="accordion-content">
        <script src="http://gist-it.appspot.com/github/fijiproject/fiji-express-music/raw/{{site.music_express_devel_branch}}/src/main/scala/org/fiji/express/music/SongPlayCounter.scala"> </script>
  </div>
</div>
