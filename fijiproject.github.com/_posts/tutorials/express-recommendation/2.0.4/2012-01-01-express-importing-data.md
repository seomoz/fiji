...
Fiji provides stock [bulk importers]({{site.userguide_mapreduce_1_2_9}}/bulk-importers/) that work for a
...
express.py job -libjars=${MUSIC_EXPRESS_HOME}/lib/* \
    --user_jar=${MUSIC_EXPRESS_HOME}/lib/fiji-express-music-2.0.4.jar \
...
{% highlight bash %}
express.py job -libjars=${MUSIC_EXPRESS_HOME}/lib/* \
    --user-jar=${MUSIC_EXPRESS_HOME}/lib/fiji-express-music-2.0.4.jar \
...
<div id="accordion-container">
  ...
  <div class="accordion-content">
        <script src="http://gist-it.appspot.com/github/fijiproject/fiji-express-music/raw/fiji-express-music-2.0.4/src/main/scala/org/fiji/express/music/SongMetadataImporter.scala"> </script>
  </div>
</div>
