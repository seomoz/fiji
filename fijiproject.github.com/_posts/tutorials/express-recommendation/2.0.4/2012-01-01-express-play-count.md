...
Data can be read from a Fiji table by using [`FijiInput`](({{site.api_express_2.0.4}}/FijiInput.html).
...
<div id="accordion-container">
  ...
  <div class="accordion-content">
        <script src="http://gist-it.appspot.com/github/fijiproject/fiji-express-music/raw/fiji-express-music-2.0.4/src/main/scala/org/fiji/express/music/SongPlayCounter.scala"> </script>
  </div>
</div>
