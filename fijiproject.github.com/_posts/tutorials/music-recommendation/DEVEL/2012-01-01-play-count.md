...
<div id="accordion-container">
  <h2 class="accordion-header"> SongPlayCounter.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-music/raw/{{site.music_devel_branch}}/src/main/java/org/fiji/examples/music/gather/SongPlayCounter.java"> </script>
     </div>
 <h2 class="accordion-header"> LongSumReducer.java </h2>
   <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-mapreduce-lib/raw/{{site.mrlib_devel_branch}}/fiji-mapreduce-lib/src/main/java/org/fiji/mapreduce/lib/reduce/LongSumReducer.java"> </script>
    </div>
</div>
...
gatherer is essentially a mapper that gets input from a [`FijiTable`]({{site.api_schema_devel}}/FijiTable.html).
...
form of a [`FijiDataRequest`]({{site.api_schema_devel}}/FijiDataRequest.html), which is defined in getDataRequest().
...
<div id="accordion-container">
  <h2 class="accordion-header"> TestSongPlayCounter.java </h2>
    <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-music/raw/{{site.music_devel_branch}}/src/test/java/org/fiji/examples/music/TestSongPlayCounter.java"> </script>
    </div>
</div>
