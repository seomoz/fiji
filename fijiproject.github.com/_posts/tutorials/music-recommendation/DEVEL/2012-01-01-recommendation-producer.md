...
<div id="accordion-container">
  <h2 class="accordion-header"> NextSongRecommender.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-music/raw/{{site.music_devel_branch}}/src/main/java/org/fiji/examples/music/produce/NextSongRecommender.java"> </script>
  </div>
</div>

<h3 style="margin-top:0px;padding-top:10px;"> NextSongRecommender </h3>
The NextSongRecommender is an example of a [FijiProducer]({{site.userguide_mapreduce_devel}}/producers).
...
In our `produce()` method, we then access our requested data through the [`FijiRowData`]({{site.api_schema_devel}}/FijiRowData.html):
...
<div id="accordion-container">
  <h2 class="accordion-header"> TestNextSongRecommender.java </h2>
    <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-music/raw/{{site.music_devel_branch}}/src/test/java/org/fiji/examples/music/TestNextSongRecommender.java"> </script>
  </div>
</div>
...
[`FijiTable`]({{site.api_schema_devel}}/FijiTable.html) we want to use to back our
