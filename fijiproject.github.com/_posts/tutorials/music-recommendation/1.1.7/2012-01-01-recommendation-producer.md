...
<div id="accordion-container">
  <h2 class="accordion-header"> NextSongRecommender.java </h2>
    ...
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-music/raw/fiji-music-1.1.7/src/main/java/org/fiji/examples/music/produce/NextSongRecommender.java"> </script>
  </div>
</div>

<h3 style="margin-top:0px;padding-top:10px;"> NextSongRecommender </h3>
The NextSongRecommender is an example of a [FijiProducer]({{site.userguide_mapreduce_1_2_9}}/producers).
...
In our `produce()` method, we then access our requested data through the [`FijiRowData`]({{site.api_schema_1_5_0}}/FijiRowData.html):
...
<div id="accordion-container">
  <h2 class="accordion-header"> TestNextSongRecommender.java </h2>
    <div class="accordion-content">
    <script src="http://gist-it.appspot.com/github/fijiproject/fiji-music/raw/fiji-music-1.1.7/src/test/java/org/fiji/examples/music/TestNextSongRecommender.java"> </script>
  </div>
</div>
