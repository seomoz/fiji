...
/**
 * Fiji analytic functions (mappers, reducers, producer, gatherers, etc.) that output
...
public interface AvroValueWriter {
  /**
   * If the output key class is {@link org.apache.avro.mapred.AvroValue}, the Fiji framework
