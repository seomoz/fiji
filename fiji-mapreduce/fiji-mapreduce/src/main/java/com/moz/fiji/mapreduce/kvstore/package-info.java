 ...
 *
 * <p>{@link com.moz.fiji.mapreduce.kvstore.KeyValueStore}s are used to provide MapReduce
 * programs and other operators processing Fiji datasets with the ability to join
 ...
 * com.moz.fiji.mapreduce.kvstore.lib}. These implementations read from a variety of file
 * formats, or Fiji tables.</p>
 *
 * <p>A Fiji table processor (Mapper, Gatherer, Producer, etc.) can specify a set of
 * key-value stores it requires, by implementing the {@link
 * com.moz.fiji.mapreduce.kvstore.KeyValueStoreClient} class. You can return a set of
 ...
 * com.moz.fiji.mapreduce.kvstore.RequiredStores} static class helpful, as it provides
 ...
 * program; use a {@link com.moz.fiji.mapreduce.framework.MapReduceJobBuilder} or related class to
 ...
 * com.moz.fiji.mapreduce.kvstore.KeyValueStoreReader} interface provides a
 ...
 * com.moz.fiji.mapreduce.kvstore.KeyValueStoreReaderFactory} to get access to the
 ...
 * com.moz.fiji.mapreduce.kvstore.KeyValueStore} interface, and provide a related {@link
 * com.moz.fiji.mapreduce.kvstore.KeyValueStoreReader} implementation as well. You can use the
 * {@link com.moz.fiji.mapreduce.kvstore.lib.FileStoreHelper} object to manage files in HDFS
 * that should be sent to your processes via the DistributedCache.</p>
 */
package com.moz.fiji.mapreduce.kvstore;
