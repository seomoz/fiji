 ...
 * When used in the Fiji framework, you may override these default implementations
 ...
 * implementations; often {@link com.moz.fiji.mapreduce.FijiContext#getStore(String)} is used within
 ...
 * {@link KeyValueStoreReader} implementation. For example, FijiProducer and FijiGatherer
...
public interface KeyValueStoreClient {
   ...
   * to the {@link com.moz.fiji.mapreduce.kvstore.lib.UnconfiguredKeyValueStore} instead.<p>
   *
   ...
   * <code>Context</code> object or similar mechanism exposed by the Fiji framework to
