...
package com.moz.fiji.mapreduce.kvstore.impl;
...
public final class KeyValueStoreConfigSerializer {
  ...
  public static final String CONF_CLASS = "fiji$kvstore$class";

  /** KeyValueStoreConfiguration variable storing the name of this KeyValueStore. */
  public static final String CONF_NAME = "fiji$kvstore$name";

  /** How many KeyValueStore definitions were serialized in the configuration? */
  public static final String CONF_KEY_VALUE_STORE_COUNT = "fiji.job.kvstores.count";
