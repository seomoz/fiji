 ...
 *
 * <p>This package contains a library of {@link com.moz.fiji.mapreduce.kvstore.KeyValueStore}
 ...
 *
 * <ul>
 *   <li>{@link com.moz.fiji.mapreduce.kvstore.lib.AvroKVRecordKeyValueStore} - Key-Value
 *   pairs specified in Avro records containing two fields, <em>key</em> and
 *   <em>value</em></li>
 *   <li>{@link com.moz.fiji.mapreduce.kvstore.lib.AvroRecordKeyValueStore} - Avro records in
 *   an Avro file, to be indexed by a configurable field of each record.</li>
 *   <li>{@link com.moz.fiji.mapreduce.kvstore.lib.SeqFileKeyValueStore} - Key-Value pairs in
 *   SequenceFiles</li>
 *   <li>{@link com.moz.fiji.mapreduce.kvstore.lib.TextFileKeyValueStore} - string key-value
 *   pairs in delimited text files</li>
 * </ul>
 *
 * <p>You can also access a specific column of a Fiji table by the row's entityId
 * using the {@link com.moz.fiji.mapreduce.kvstore.lib.FijiTableKeyValueStore}.</p>
 *
 ...
 * com.moz.fiji.mapreduce.kvstore.lib.UnconfiguredKeyValueStore}. It will throw an IOException
 ...
 *
 * <p>The {@link com.moz.fiji.mapreduce.kvstore.lib.EmptyKeyValueStore} is a good default
 ...
 * com.moz.fiji.mapreduce.kvstore.lib.FileStoreHelper} object helpful; it will track the
 ...
 * com.moz.fiji.mapreduce.kvstore.lib.EmptyKeyValueStore}) can also be created through other
 * factory methods, like <code>get()</code>.</p>
 *
 * <p>In your <code>getRequiredStores()</code> method, you may find the {@link
 * com.moz.fiji.mapreduce.kvstore.RequiredStores} class helpful in quickly assembling a set
 ...
 * com.moz.fiji.mapreduce.kvstore.KeyValueStoreReaderFactory} object to deserialize all
