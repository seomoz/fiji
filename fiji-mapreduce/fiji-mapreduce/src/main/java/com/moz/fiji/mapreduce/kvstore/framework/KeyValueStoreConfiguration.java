...
package com.moz.fiji.mapreduce.kvstore.framework;
...
public final class KeyValueStoreConfiguration {
   ...
   * keys under the "fiji.kvstores.[i]" namespace.
   */
  public static final String KEY_VALUE_STORE_NAMESPACE = "fiji.job.kvstores.";
   ...
   * entry in the "fiji.job.kvstores" namespace in a new Configuration object
   * (e.g.,  calling <code>set("foo", ...)</code> on the returned object will
   * set key <tt>fiji.job.kvstores.0.foo</tt>).
   * </p>
   *
   ...
   * set key <tt>fiji.job.kvstores.3.foo</tt> in <code>conf</code>.</p>
   *
