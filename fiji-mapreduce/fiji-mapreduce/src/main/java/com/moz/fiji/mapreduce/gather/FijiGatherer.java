...
import com.moz.fiji.mapreduce.KVOutputJob;
...
/**
 * <p>
 * Base class for all Fiji Gatherers.  Gatherers are jobs that scan a
 * fiji table and aggregate data into an external file.
 * </p>
 *
 * <h1>Lifecycle:</h1>
 *
 ...
 *
 * <p>
 * As a {@link KeyValueStoreClient}, FijiGatherers will have access to all
 ...
 * <h1>Skeleton:</h1>
 * <p>
 *   Any concrete implementation of a FijiGatherer must implement the {@link #getDataRequest()},
 ...
 *   }
 * </code></pre>
 * For the entire code for this gatherer, check out EmailDomainCountGatherer in FijiMR Lib.
 *
...
public abstract class FijiGatherer<K, V>
   ...
   * #setup(com.moz.fiji.mapreduce.gather.GathererContext)}.
   *
  ...
  /**
   * Called once per row in the fiji table.
   *
   * @param input A single for of input from the Fiji table, filled with the data requested.
   * @param context A gatherer context, used to write key/value output.
   * @throws IOException If there is an error.
   */
  public abstract void gather(FijiRowData input, GathererContext<K, V> context)
      throws IOException;
