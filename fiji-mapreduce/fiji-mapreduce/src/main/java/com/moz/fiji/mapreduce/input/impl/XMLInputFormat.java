...
package com.moz.fiji.mapreduce.input.impl;
...
public final class XMLInputFormat extends FileInputFormat<LongWritable, Text> {
  ...
  public static final String RECORD_TAG_CONF_KEY = "fiji.input.xml.record.tag";
  /** Configuration key for XML version and encoding information. */
  public static final String XML_HEADER_CONF_KEY = "fiji.input.xml.header";
  /**
   ...
   */
  public static final String XML_OVERRUN_CONF_KEY = "fiji.input.xml.overrun.allowance";
