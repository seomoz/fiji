 ...
 * files, a Fiji table, or some other resource like a different NoSQL database.
 * See the {@link com.moz.fiji.mapreduce.kvstore.lib} package for implementations.</p>
 *
 * <p>The {@link com.moz.fiji.mapreduce.kvstore.KeyValueStoreReader} interface defines
 ...
 *
 * <p>Within the Fiji framework, a KeyValueStore may be used within a MapReduce job,
 ...
 *
 * <h1>Lifecycle in the Fiji ecosystem:</h1>
 ...
 * programmatically by using a subclass of MapReduceJobBuilder (e.g., FijiProduceJobBuilder).
