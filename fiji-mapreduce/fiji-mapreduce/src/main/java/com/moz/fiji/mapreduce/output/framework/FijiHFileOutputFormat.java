...
package com.moz.fiji.mapreduce.output.framework;
 ...
 * {@link com.moz.fiji.mapreduce.HFileLoader}.
 */
@ApiAudience.Framework
@ApiStability.Stable
public final class FijiHFileOutputFormat
    extends FileOutputFormat<HFileKeyValue, NullWritable> {
  private static final Logger LOG = LoggerFactory.getLogger(FijiHFileOutputFormat.class);
  ...
  public static final String CONF_LATEST_TIMESTAMP = "fiji.hfile.latest.timestamp";
  ...
  private static class TableRecordWriter
     ...
     *
     * @param oformat FijiHFileOutputFormat this writer is built from.
     * @param context Context of the task.
     * @throws IOException on I/O error.
     */
    public TableRecordWriter(FijiHFileOutputFormat oformat, TaskAttemptContext context)
        throws IOException {
