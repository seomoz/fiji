...
public final class MapReduceJobOutputs {
   ...
   * @return a new HFileMapReduceJobOutput initialized with the intended fiji table and
   * output directory path.
   */
  public static HFileMapReduceJobOutput newHFileMapReduceJobOutput(FijiURI tableURI, Path path) {
   ...
   * @return a new HFileMapReduceJobOutput initialized with the intended fiji table, output
   * directory path, and number of splits (hashRowKeys-enabled Fiji table only).
   */
  public static HFileMapReduceJobOutput newHFileMapReduceJobOutput(
      FijiURI tableURI, Path path, int numSplits) {
  ...
  /**
   * Creates a new uninitialized DirectFijiTableMapReduceJobOutput.
   * @return a new uninitialized DirectFijiTableMapReduceJobOutput.
   */
  public static DirectFijiTableMapReduceJobOutput newDirectFijiTableMapReduceJobOutput() {
    return new DirectFijiTableMapReduceJobOutput();
  }

  /**
   * Creates a new DirectFijiTableMapReduceJobOutput with the Fiji table only.
   * @param tableURI The Fiji table to write to.
   * @return a new DirectFijiTableMapReduceJobOutput initialized with a Fiji Table URI.
   */
  public static DirectFijiTableMapReduceJobOutput newDirectFijiTableMapReduceJobOutput(
      FijiURI tableURI) {
    return new DirectFijiTableMapReduceJobOutput(tableURI);
  }

  /**
   * Creates a new DirectFijiTableMapReduceJobOutput.
   * @param tableURI The Fiji table to write to.
   * @param numReduceTasks The number of reduce tasks to use (use zero if using a producer).
   * @return a new DirectFijiTableMapReduceJobOutput initialized with a Fiji Table URI and
   * the number of reduce tasks.
   */
  public static DirectFijiTableMapReduceJobOutput newDirectFijiTableMapReduceJobOutput(
      FijiURI tableURI, int numReduceTasks) {
    return new DirectFijiTableMapReduceJobOutput(tableURI, numReduceTasks);
  }
