 ...
 * usually a URL or filesystem path.  For a Fiji table, it is simply the name of the
 * table.</p>
 *
...
public final class JobInputSpec {
  /**
   * The Job input formats supported by Fiji.  In the string representation of a
