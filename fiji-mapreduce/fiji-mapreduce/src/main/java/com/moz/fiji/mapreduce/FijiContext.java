...
/** Interface for contexts passed to FijiMR methods. */
@ApiAudience.Public
@ApiStability.Stable
@Inheritance.Sealed
public interface FijiContext extends Closeable, Flushable {
  /**
   ...
   * FijiProducer/Gatherer/BulkImporter associated with this Context.</p>
   *
  ...
  /**
   * Report progress to the fiji framework.
   *
  ...
  /**
   * Sets a status string for the fiji task.
   *
