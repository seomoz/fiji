...
/**
 * <p>A FijiReducer that works on key/value pairs where the value is
 ...
 *
 * This class is for testing in FijiMR.  To use this in actual MapReduce jobs, use the
 * IntSumReducer in the FijiMR Library.
 *
 * @param <K> The type of the reduce input key.
 */
public class SimpleIntSumReducer<K> extends FijiReducer<K, IntWritable, K, IntWritable>
