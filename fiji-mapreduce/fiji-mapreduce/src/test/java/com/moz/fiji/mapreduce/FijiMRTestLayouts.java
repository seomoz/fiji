...
/** Layouts used for testing FijiMR. */
public final class FijiMRTestLayouts {

  /**
   * Alias for FijiTableLayouts.getLayout(resource).
   *
  ...
  public static TableLayoutDesc getLayout(String resourcePath) throws IOException {
    return FijiTableLayouts.getLayout(resourcePath);
  }

  /** Generic test layout with user info, all primitive types, a map-type family of strings. */
  public static final String TEST_LAYOUT = "com.moz.fiji/mapreduce/layout/test.json";
  /** Multiple locality group test layout. */
  public static final String LG_TEST_LAYOUT = "com.moz.fiji/mapreduce/layout/lgtest.json";
