...
import com.moz.fiji.schema.filter.ColumnValueEqualsRowFilter;
import com.moz.fiji.schema.filter.FijiRowFilter;
import com.moz.fiji.schema.testutil.FooTableIntegrationTest;

/** Tests for the FijiTableInputFormat. */
public class IntegrationTestFijiTableInputFormat
    extends FooTableIntegrationTest {

  public static class TestMapper
      extends Mapper<EntityId, FijiRowData, Text, Text> {
  ...
  public Job setupJob(
      ...
      EntityId startKey,
      EntityId limitKey,
      FijiRowFilter filter) throws Exception {
    ...
    FijiTableInputFormat.configureJob(job, getFooTable().getURI(), request,
