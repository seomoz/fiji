 ...
 *
 * Expects the layout described in src/test/resources/com.moz.fiji/mapreduce/layout/test.json
 */
public class SimpleBulkImporter extends FijiBulkImporter<LongWritable, Text> {
