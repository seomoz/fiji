...
/**
 * Factory for CDH5 FijiMRPlatformBridge implementation.
 *
 ...
 */
@ApiAudience.Private
public final class CDH5FijiMRBridgeFactory extends FijiMRPlatformBridgeFactory {
    ...
    try {
      Class<? extends FijiMRPlatformBridge> bridgeClass =
          (Class<? extends FijiMRPlatformBridge>) Class.forName(
              "com.moz.fiji.mapreduce.platform.CDH5FijiMRBridge");
