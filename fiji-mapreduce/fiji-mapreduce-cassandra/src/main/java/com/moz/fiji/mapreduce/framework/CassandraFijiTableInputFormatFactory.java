 ...
 */
public class CassandraFijiTableInputFormatFactory implements FijiTableInputFormatFactory {
  /** {@inheritDoc} */
  @Override
  public FijiTableInputFormat getInputFormat() {
    return new CassandraFijiTableInputFormat();
  }

  /** {@inheritDoc} */
  @Override
  public String getName() {
    return CassandraFijiURI.CASSANDRA_SCHEME;
  }
}
