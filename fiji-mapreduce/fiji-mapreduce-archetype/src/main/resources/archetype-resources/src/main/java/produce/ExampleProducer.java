 ...
 */
public class ExampleProducer extends FijiProducer {
  private FijiColumnName mInputColumn = new FijiColumnName("family:qualifier");
  private FijiColumnName mOutputColumn = new FijiColumnName("family:outputqualifier");
