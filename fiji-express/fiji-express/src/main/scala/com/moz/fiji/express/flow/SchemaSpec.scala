...
/**
 * A specification describing the schema to use when reading or writing values to a column in a Fiji
 * table.
 *
 ...
 * schemas that should be used when reading/writing data from/to Fiji tables. SchemaSpec also
 * provides the ability to use Avro SpecificRecords defined using
 * [[http://avro.apache.org/docs/current/idl.html Avro's IDL]].
 *
 * @note Defaults to [[com.moz.fiji.express.flow.SchemaSpec.Writer SchemaSpec.Writer]] when reading or
 *     writing data.
 * @example SchemaSpec usage.
 *      - [[com.moz.fiji.express.flow.SchemaSpec.DefaultReader SchemaSpec.DefaultReader]] - Use the
 ...
 *        }}}
 *      - [[com.moz.fiji.express.flow.SchemaSpec.Writer SchemaSpec.Writer]] - Use the schema that the
 ...
 *        }}}
 *      - [[com.moz.fiji.express.flow.SchemaSpec.Generic SchemaSpec.Generic]] - Use the specified Avro
 ...
 *        }}}
 *      - [[com.moz.fiji.express.flow.SchemaSpec.Specific SchemaSpec.Specific]] - Use the specified Avro
 ...
 *        }}}
 * @see [[com.moz.fiji.express.flow.ColumnFamilyInputSpec]] for information about using SchemaSpec when
 *     reading data from a Fiji column family.
 * @see [[com.moz.fiji.express.flow.QualifiedColumnInputSpec]] for information about using SchemaSpec
 *     when reading data from a Fiji column.
 * @see [[com.moz.fiji.express.flow.ColumnFamilyOutputSpec]] for information about using SchemaSpec
 *     when writing data to a Fiji column family.
 * @see [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec]] for information about using SchemaSpec
 *     when writing data to a Fiji column.
 */
@ApiAudience.Public
@ApiStability.Stable
sealed trait SchemaSpec extends Serializable {
   ...
   * if possible.
   */
  private[fiji] def schema: Option[Schema]
}

/**
 * Provides [[com.moz.fiji.express.flow.SchemaSpec]] implementations.
 */
@ApiAudience.Public
@ApiStability.Stable
object SchemaSpec {
   ...
   *
   * @see [[com.moz.fiji.express.flow.SchemaSpec]] for more usage information.
   *
   ...
   * Fiji table has a default reader specified.
   *
   * @see [[com.moz.fiji.express.flow.SchemaSpec]] for more usage information.
   */
  @ApiAudience.Public
