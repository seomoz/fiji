...
/**
 * A specification describing how to write data from a scalding tuple field to a Fiji table.
 * Provides access to options common to all types of column output specs. There are two types of
 * column output specs:
 * <ul>
 *   <li>
 *     [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec]] - Describes how to write data from a
 *     scalding tuple to a column in a Fiji table.
 *   </li>
 *   <li>
 *     [[com.moz.fiji.express.flow.ColumnFamilyOutputSpec]] - Describes how to write data from a
 *     scalding tuple to a column family in a Fiji table.
 *   </li>
 * </ul>
 *
 * To see more information about writing data to a Fiji table, see
 * [[com.moz.fiji.express.flow.FijiOutput]].
 *
...
sealed trait ColumnOutputSpec {
  /**
   * The [[com.moz.fiji.schema.FijiColumnName]] to write data to.
   *
...
/**
 * Provides factory functions for creating [[com.moz.fiji.express.flow.ColumnOutputSpec]] instances.
 */
@ApiAudience.Public
@ApiStability.Stable
...
/**
 * A specification describing how to write data from a scalding tuple field to a column in a Fiji
 * table.
 *
 * Example usages:
 *
...
/**
 * Provides factory functions for creating [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec]]
 * instances.
 */
@ApiAudience.Public
@ApiStability.Stable
object QualifiedColumnOutputSpec {
  ...
  private[express] def fromColumnName(column: String): QualifiedColumnOutputSpec =
      builder.withColumn(new FijiColumnName(column)).build
  ...
  final class Builder private(
    ...
    /**
     * Configure the output spec to write to the given Fiji column.
     *
    ...
    /**
     * Configure the output spec to write to the given Fiji column family. Must also call
     * [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec.Builder.withQualifier()]] before calling
     * [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec.Builder.build]].
     *
     * @param family of the column into which to write.
     * @return this builder.
     */
    ...
    /**
     * Configure the output spec to write tot he given Fiji column qualifier. Must also call
     * [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec.Builder.withFamily()]] before calling
     * [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec.Builder.build]].
     *
     * @param qualifier of the column into which to write.
     * @return this builder.
    ...
    /**
     * Name of the Fiji column family into which to write.
     *
     * @return the name of the Fiji column family into which to write.
     */
    def family: Option[String] = monitor.synchronized(mFamily)

    /**
     * Name of the Fiji column qualifier into which to write.
     *
     * @return the name of the Fiji column qualifier into which to write.
     */
   ...
   * [[com.moz.fiji.express.flow.QualifiedColumnOutputSpec.Builder]].
   */
  @ApiAudience.Public
  @ApiStability.Stable
  object Builder {
...
/**
 * Provides factory functions for creating [[com.moz.fiji.express.flow.ColumnFamilyOutputSpec]]
 * instances.
 */
@ApiAudience.Public
@ApiStability.Stable
object ColumnFamilyOutputSpec {
  ...
  /**
   * A specification describing how to write data from a scalding tuple field to a family of columns
   * in a Fiji table with a [[com.moz.fiji.express.flow.SchemaSpec.Generic]] Avro writer schema.
   *
   * @param family of the column to write to.
  ...
  /**
   * Companion object providing factory methods for creating new instances of
   * [[com.moz.fiji.express.flow.ColumnFamilyOutputSpec.Builder]].
   */
  @ApiAudience.Public
  @ApiStability.Stable
  object Builder {
