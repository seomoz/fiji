...
trait AvroTupleConversions {
   ...
   * [[com.moz.fiji.express.flow.util.AvroSpecificTupleConverter]] for converting fields
  ...
  /**
   * Provides an [[com.moz.fiji.express.flow.util.AvroTupleConversions.AvroSpecificTuplePacker]] to the
   * implicit scope.
   *
   ...
   * @return [[com.moz.fiji.express.flow.util.AvroTupleConversions.AvroSpecificTuplePacker]] for given
  ...
  /**
   * Provides an [[com.moz.fiji.express.flow.util.AvroTupleConversions.AvroGenericTupleUnpacker]] to
   * implicit scope.
   *
   * @return an [[com.moz.fiji.express.flow.util.AvroTupleConversions.AvroGenericTupleUnpacker]].
   */
...
private[express] class AvroGenericTupleConverter(fs: Fields, schema: Schema)
  ...
  private val schemaExternalizer = FijiKryoExternalizer(schema)
