...
public class StandalonePhonebookImporter extends Configured implements Tool {
   ...
   * @throws IOException If there is an error contacting Fiji or reading the input file.
   */
  @Override
  public int run(String[] args) throws IOException {
    // Parse command-line arguments, populating mFijiURIName and mInputData.
    ...
    mFijiURI = FijiURI.newBuilder(mFijiUriName).build();
    ...
    FijiTableWriter writer = null;
    BufferedReader reader = null;
    try {
      // Connect to Fiji and open the table.
      fiji = Fiji.Factory.open(mFijiURI, getConf());
   ...
   */
  private void importLine(String phonebookLine, FijiTable table, FijiTableWriter writer)
