...
/**
 * Command line tools for the Fiji Hive Adapter that belong in the base Fiji library directory
 * rather than than as a standalone fat jar to be incorporated into Hive.
 *
 * <ul>
 *   <li>{@link CreateHiveTableTool} - CLI tool that reads the layout of a Fiji table and outputs
