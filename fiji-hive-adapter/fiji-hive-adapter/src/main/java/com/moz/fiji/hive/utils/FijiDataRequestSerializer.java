...
/**
 * Serializes and deserializes a FijiDataRequest such that it is safe for Job configuration.
 */
public final class FijiDataRequestSerializer {

  /** Utility class cannot be instantiated. */
  private FijiDataRequestSerializer() {}
